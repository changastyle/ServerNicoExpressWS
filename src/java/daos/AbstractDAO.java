...
public class AbstractDAO
{
    ...
    public static boolean updateAsTransaction(ArrayList<Object> arrObjectosAUpdatear)
    {
        boolean updateo = true;
        ...
        try
        {
            ...
            for(Object object : arrObjectosAUpdatear)
            {
                 sessionProvisoria.update(object);
            }
        ...
        catch(Exception e)
        {
            ...
            updateo = false;
            e.printStackTrace();
            System.out.println("ERROR: AbstractDAO -> delete: " + arrObjectosAUpdatear);
        }
